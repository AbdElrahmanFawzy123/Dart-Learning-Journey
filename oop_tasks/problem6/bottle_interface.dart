...
Create an interface called Bottle and add a method to it called open().
 Create a class called CokeBottle and implement the Bottle and
  print the message “Coke bottle is opened”.
...
*/
import 'cokebottle_class.dart';

abstract class Bottle {
  void open();
  factory Bottle() => CockBottle();
}
